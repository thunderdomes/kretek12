<?php get_header(); ?>
	...
	if (have_posts()) : ?>
		...
		<?php $post = $posts[0]; ?>
            ...
            <h2 class="leading upperfont"><?php _e('Archive for','themnific');?> <?php the_time('F jS, Y'); ?></h2>
            
            <?php } elseif (is_month()) { ?>
            
            <h2 class="leading upperfont"><?php _e('Archive for','themnific');?> <?php the_time('F, Y'); ?></h2>
            
            <?php } elseif (is_year()) { ?>
            
            <h2 class="leading upperfont"><?php _e('Archive for','themnific');?> <?php the_time('Y'); ?></h2>
            
            <?php } elseif (is_author()) { ?>
            
            <h2 class="leading upperfont"><?php _e('Author Archive','themnific');?></h2>
            
            <?php } elseif (isset($_GET['paged']) && !empty($_GET['paged'])) { ?>
            
            <h2 class="leading upperfont"><?php _e('Blog Archives','themnific');?></h2>
