...
<?php if (get_option('themnific_socials_gi') == "") {} else { ?>
<li class="sprite-github"><a class="mk-social-github" title="Github" href="<?php echo get_option('themnific_socials_gi');?>"></a></li><?php } ?>
