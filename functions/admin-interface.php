...
function themnificthemes_machine($options) {
	...
	foreach ($options as $value) {
		...
		case "typography":
			...
			if (strpos($val, 'Amatic SC') !== false){ $font56 = 'selected="selected"'; }
			if (strpos($val, 'Source Sans Pro') !== false){ $font57 = 'selected="selected"'; }
			if (strpos($val, 'Lora') !== false){ $font58 = 'selected="selected"'; }
			...
			$output .= '<option value="&quot;Amatic SC&quot;, sans-serif" '. $font56 .'>Amatic SC***</option>';
			$output .= '<option value="&quot;Source Sans Pro&quot;, sans-serif" '. $font57 .'>Source Sans Pro***</option>';
			$output .= '<option value="&quot;Lora&quot;, sans-serif" '. $font58 .'>Lora***</option>';
			$output .= '</select>';
